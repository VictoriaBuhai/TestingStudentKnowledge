...
namespace TSKTests.Tests
{
    public class UserTestAccessServiceTests
    {
        ...
        public void GetAllAllowTestsByUserEmailTest()
        {
            ...
            {
                new TestViewModel(){Id = 1, Name = "Test1", timeLimit = 10, User = new UserViewModel () { FirstName = "Name1",
                LastName = "Name2" } },
                new TestViewModel(){Id = 2, Name = "Test2", timeLimit = 10, User = new UserViewModel () { FirstName = "Name1",
                LastName = "Name2" } }
            };
        ...
        public void SetAllowTest()
        {
            ...
            var managerMock = new DataManagerMock(new AnswersRepositoryMock(), new TestsRepositoryMock(),
                new QuestionsRepositoryMock(), new UsersRepositoryMock(), new CorrectAnswerRepositoryMock(), userTestAccessRepositoryMock);
            var userTestAccessService = new UserTestAccessService(managerMock);
